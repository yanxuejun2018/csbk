<template>
	<view class="animated fadeIn fast" v-if="show">
		...
		<view class="more-share-model" @tap="togle">
			...
			<scroll-view scroll-x class="more-share-body">
				<block v-for="(val,index) in providerList" :key=index>
					<view class="more-share-item " hover-class="more-share-hover" @tap="share(val)">
						<view class="icon iconfont" :class="['icon-'+val.zicon,'more-share-'+val.zclass]"></view>
						<view>{{val.name}}</view>
					</view>
				</block>
				
			</scroll-view>
			<view class="more-share-bottom" hover-class="more-share-hover" @tap="togle">
				取消
			</view>
		</view>
	</view>
