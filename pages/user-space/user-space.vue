...
<script>
	import userSpaceHead from "../../componets/user-space/user-space-head.vue"
	import homeData from "../../componets/home/home-data.vue"
		import swiperTabHead from "../../componets/index/swiper-tab-header.vue";
		import userSpaceUserinfo from "../../componets/user-space/user-space-userinfo.vue"
		import commonList from "../../componets/common/common-list.vue";
	import loadMore from "../../componets/common/load-more.vue";
	import userSpacePopup from "../../componets/user-space/user-space-popup.vue"
