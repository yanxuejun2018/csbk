<template>
	<view>
		...
		<view class="body">
			...
			<template v-if="!status">
				...
				<view class="login-input-box">
					...
					placeholder="请输入密码" />
					<view class="forget login-font-color">忘记密码</view>
				</view>
			</template>
			...
			<template v-else>
				...
				<view class="login-input-box">
					...
					class="uni-input common-input forget-input"
					placeholder="请输入验证码" />
					<view class="forget  login-font-color yanzhengma"
					@tap="getCheckNum">
		...
		<!-- 协议 -->
		<view class="login-rule  login-padding login-font-color">
...
<script>
	import uniStatusBar from "../../componets/uni-status-bar/uni-status-bar.vue"
